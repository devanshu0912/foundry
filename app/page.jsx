      ...
      <main>
        ...
        <section style={{ background: 'var(--black)', color: 'var(--white)', position: 'relative', overflow: 'hidden' }}>
          ...
          <div className="container" style={{ position: 'relative', paddingTop: 'var(--sp-24)', paddingBottom: 'var(--sp-20)' }}>
            ...
            {/* CTAs */}
            <div style={{ display: 'flex', gap: '0.75rem', marginBottom: 'var(--sp-16)' }}>
        ...
        {jobs.length > 0 && (
          <section className="section">
            <div className="container">
              ...
              {/* Community strip */}
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'var(--gray-50)', border: '1px solid var(--gray-200)', borderRadius: 'var(--radius-xl)', padding: 'var(--sp-5) var(--sp-6)', gap: 'var(--sp-4)' }}>
                <div>
                  <p style={{ fontSize: 'var(--text-sm)', fontWeight: 600, color: 'var(--gray-900)', marginBottom: '0.25rem' }}>Get jobs before anyone else</p>
                  <p style={{ fontSize: 'var(--text-xs)', color: 'var(--gray-400)' }}>New roles dropped daily — no spam, just opportunities.</p>
                </div>
                <div style={{ display: 'flex', gap: '0.5rem', flexShrink: 0 }}>
                  <a href="https://t.me/yourchannel" target="_blank" rel="noopener noreferrer"
                    style={{ display: 'flex', alignItems: 'center', gap: '0.375rem', fontSize: 'var(--text-xs)', fontWeight: 600, background: '#229ED9', color: '#fff', padding: '0.5rem 1rem', borderRadius: 'var(--radius-md)', textDecoration: 'none' }}>
                  ...
                  <a href="https://wa.me/919000000000" target="_blank" rel="noopener noreferrer"
                    style={{ display: 'flex', alignItems: 'center', gap: '0.375rem', fontSize: 'var(--text-xs)', fontWeight: 600, background: '#25D366', color: '#fff', padding: '0.5rem 1rem', borderRadius: 'var(--radius-md)', textDecoration: 'none' }}>
